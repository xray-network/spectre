...
at `.agents/spectre/SPECTRE-PROTOCOL.md`, its command entrypoint lives at
`.agents/skills/spectre/SKILL.md`, and the project's root `SPECTRE.md` summarizes every
implementation and is the sole lifecycle ledger.
...
<a href="/spectre/protocol/v3.0.0/SPECTRE-PROTOCOL.md">immutable SPECTRE 3.0.0 protocol</a>.
